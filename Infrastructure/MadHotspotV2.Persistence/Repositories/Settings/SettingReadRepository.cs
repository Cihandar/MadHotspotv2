...
{
    public class SettingReadRepository : ReadRepository<Setting>, ISettingsReadRepository
    {
        public SettingReadRepository(MadHotspotV2DbContext context) : base(context)
        {
        }
    }
}
